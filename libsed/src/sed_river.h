...
Sed_riv sed_river_set_data     ( Sed_riv s , GQuark key_id , gpointer data );
Sed_riv sed_river_set_data_full( Sed_riv s , GQuark key_id , gpointer data , GDestroyNotify func );
...
gpointer  sed_river_data    ( Sed_riv s , GQuark key_id );
...
Sed_riv* sed_river_mouths( Sed_riv s );

gint    sed_river_fprint( FILE* fp , Sed_riv s );
gint    sed_river_fread ( FILE* fp , Sed_riv d );
