...
Eh_histogram**
eh_create_histogram(double dx, gint n);
void
eh_destroy_histogram(Eh_histogram** h);
Eh_histogram**
make_depth_histogram(double* x, int n_x, double dz, gint n_z);

double
get_weibull_deposition_rate(double x, double alpha, double beta);
double
get_threshold_depth(double wave_length, double wave_height,
...
*/
gboolean
squall(Sed_cube p, double time_step_in_years)
{
...
void
add_to_hist(Eh_histogram** hist, gint bin, double f, gint ind);
...
*/
double
get_erosion_rate_from_profile(Sed_cube p, int i,
...
*/
double
get_shoreface_slope(Sed_cube p, int i_c, int i_w)
{
...
*/
double
get_erosion_rate(double h, double h_w, double h_c,
...
*/
double
get_erosion_efficiency(double h, double h_w, double h_c)
{
...
double
get_coastal_dissipation(double alpha_sf)
{
...
*/
double
get_coastal_wave_energy(double wave_height_actual,
...
*/
double
get_wave_base(double wave_length)
{
...
*/
double
get_breaking_wave_base(double wave_height)
{
...
*/
double
get_deep_water_wave_base(double wave_height)
{
...
*/
int*
get_zone_boundaries(Sed_cube p, double h_w, double h_c)
{
    int i;
...
*/
double
get_travel_dist(double grain_size_in_m, double depth, double dx)
{
...
*/
double
get_non_dim_travel_dist(double grain_size_in_m)
{
...
*/
double*
get_moveable_grains(double water_depth,
    double wave_height,
    double wave_period,
    Sed_sediment sed,
    double* is_moveable)
