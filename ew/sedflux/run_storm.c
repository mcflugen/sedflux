...
GSList*
get_equivalent_storm(GFunc    get_storm,
    gpointer user_data,
    double   n_days,
...
double*
get_wave_from_beaufort_scale_power_law(double beaufort_storm,
    double* wave);
double
get_wind_from_beaufort_scale(double beaufort_storm);
double
get_wave_length_from_wind(double wind_speed_in_mps);
double
get_wave_period_from_wind(double wind_speed_in_mps);
double
get_wave_height_from_wind(double wind_speed_in_mps);

double*
get_wave_from_beaufort_scale(double beaufort_storm, double* wave);
double
get_height_from_beaufort_scale(double beaufort_storm);
double
get_beaufort_scale_from_height(double wave_height);
double
get_wave_length_from_height(double wave_height);
double
get_wave_period_from_height(double wave_height_in_meters);
...
init_storm(Sed_process p, Eh_symbol_table tab, GError** error)
{
    ...
    if (!tmp_err) {
        data->wave_height        = eh_symbol_table_input_value(tab, STORM_KEY_WAVE_HEIGHT,
                &tmp_err);
...
*/
double
storm(GRand* rand, double storm_length, double average_storm, double variance,
    double last_storm)
{
    double alpha, f, a;
    static long seed[1];
...
void
set_ocean_storm_wave(Sed_ocean_storm s, gpointer user_data);
Sed_ocean_storm
average_storms(GSList* storms);
void
free_link_data(gpointer data, gpointer user_data);
gint
cmp_storm_size(Sed_ocean_storm a, Sed_ocean_storm b);
gint
cmp_storm_time(Sed_ocean_storm a, Sed_ocean_storm b);
void
print_ocean_storm_list(GSList* list);
void
print_ocean_storm(Sed_ocean_storm this_storm, gpointer user_data);
...
Sed_ocean_storm
average_storms(GSList* storm_list)
{
    ...
    if (storm_list) {
        ...
        for (this_link = storm_list ; this_link ; this_link = this_link->next) {
            ...
            storm_val += pow(sed_ocean_storm_val(this_storm),
                    2.5) * sed_ocean_storm_duration(this_storm);
...
*/
double*
get_wave_from_beaufort_scale_old(double beaufort_storm, double* wave)
{
