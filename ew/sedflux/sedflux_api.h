...
Sedflux_state*
sedflux_initialize(const int argc, const char* argv[]);
...
double*
sedflux_get_value_data(Sedflux_state* state, const char* val_s,
    int dimen[3]);
double*
...
double*
sedflux_get_double(Sedflux_state* state, const char* val_s,
    int* n_dim, int** shape);
double*
sedflux_get_value_cube(Sedflux_state* state, const char* val_s,
    int dimen[3]);
int*
sedflux_get_value_dimen(Sedflux_state* state, const char* val_s,
    int dimen[3]);
int*
sedflux_get_value_shape(Sedflux_state* state, const char* val_s,
    int* n_dim);
double*
sedflux_get_value_res(Sedflux_state* state, const char* val_s,
    double res[3]);
double*
...
void
sedflux_set_erosion(Sedflux_state* state, const double* val);
void
