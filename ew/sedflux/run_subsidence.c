...
int
get_tectonics(GArray* rate_array, double year, double* rate_resample, int len);
...
gboolean
dump_subsidence_data(gpointer ptr, FILE* fp)
{
...
gboolean
load_subsidence_data(gpointer ptr, FILE* fp)
{
    Subsidence_t* data = (Subsidence_t*)ptr;
    guint len;
