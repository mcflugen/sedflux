...
*/
gboolean
init_avulsion(Sed_process, Eh_symbol_table, GError**);
gboolean
init_bbl(Sed_process, Eh_symbol_table, GError**);
gboolean
init_bedload(Sed_process, Eh_symbol_table, GError**);
gboolean
init_bioturbation(Sed_process, Eh_symbol_table, GError**);
gboolean
init_compaction(Sed_process, Eh_symbol_table, GError**);
gboolean
init_constants(Sed_process, Eh_symbol_table, GError**);
gboolean
init_cpr(Sed_process, Eh_symbol_table, GError**);
gboolean
init_data_dump(Sed_process, Eh_symbol_table, GError**);
gboolean
init_debris_flow(Sed_process, Eh_symbol_table, GError**);
gboolean
init_diffusion(Sed_process, Eh_symbol_table, GError**);
gboolean
init_erosion(Sed_process, Eh_symbol_table, GError**);
gboolean
init_failure(Sed_process, Eh_symbol_table, GError**);
gboolean
init_flow(Sed_process, Eh_symbol_table, GError**);
gboolean
init_isostasy(Sed_process, Eh_symbol_table, GError**);
gboolean
init_met_station(Sed_process, Eh_symbol_table, GError**);
gboolean
init_new_process(Sed_process, Eh_symbol_table, GError**);
gboolean
init_plume(Sed_process, Eh_symbol_table, GError**);
gboolean
init_plume_hypo(Sed_process, Eh_symbol_table, GError**);
gboolean
init_inflow(Sed_process, Eh_symbol_table, GError**);
gboolean
init_quake(Sed_process, Eh_symbol_table, GError**);
gboolean
init_sea_level(Sed_process, Eh_symbol_table, GError**);
gboolean
init_squall(Sed_process, Eh_symbol_table, GError**);
gboolean
init_storm(Sed_process, Eh_symbol_table, GError**);
gboolean
init_subsidence(Sed_process, Eh_symbol_table, GError**);
gboolean
init_tide(Sed_process, Eh_symbol_table, GError**);
gboolean
init_river(Sed_process, Eh_symbol_table, GError**);
gboolean
init_xshore(Sed_process, Eh_symbol_table, GError**);

/* All of the run functions for my processes
*/
Sed_process_info
run_avulsion(Sed_process, Sed_cube);
Sed_process_info
run_bbl(Sed_process, Sed_cube);
Sed_process_info
run_bedload(Sed_process, Sed_cube);
Sed_process_info
run_bioturbation(Sed_process, Sed_cube);
Sed_process_info
run_compaction(Sed_process, Sed_cube);
Sed_process_info
run_constants(Sed_process, Sed_cube);
Sed_process_info
run_cpr(Sed_process, Sed_cube);
Sed_process_info
run_data_dump(Sed_process, Sed_cube);
Sed_process_info
run_debris_flow(Sed_process, Sed_cube);
Sed_process_info
run_diffusion(Sed_process, Sed_cube);
Sed_process_info
run_erosion(Sed_process, Sed_cube);
Sed_process_info
run_failure(Sed_process, Sed_cube);
Sed_process_info
run_flow(Sed_process, Sed_cube);
Sed_process_info
run_isostasy(Sed_process, Sed_cube);
Sed_process_info
run_met_station(Sed_process, Sed_cube);
Sed_process_info
run_new_process(Sed_process, Sed_cube);
Sed_process_info
run_plume(Sed_process, Sed_cube);
Sed_process_info
run_plume_hypo(Sed_process, Sed_cube);
Sed_process_info
run_plume_hyper_inflow(Sed_process, Sed_cube);
Sed_process_info
run_plume_hyper_sakura(Sed_process, Sed_cube);
Sed_process_info
run_inflow(Sed_process, Sed_cube);
Sed_process_info
run_sakura(Sed_process, Sed_cube);
Sed_process_info
run_quake(Sed_process, Sed_cube);
Sed_process_info
run_river(Sed_process, Sed_cube);
Sed_process_info
run_sea_level(Sed_process, Sed_cube);
Sed_process_info
run_squall(Sed_process, Sed_cube);
Sed_process_info
run_slump(Sed_process, Sed_cube);
Sed_process_info
run_storm(Sed_process, Sed_cube);
Sed_process_info
run_subsidence(Sed_process, Sed_cube);
Sed_process_info
run_tide(Sed_process, Sed_cube);
Sed_process_info
run_xshore(Sed_process, Sed_cube);
Sed_process_info
run_turbidity_inflow(Sed_process, Sed_cube);
