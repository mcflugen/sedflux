...
double**
read_sea_level_curve(char*, gint*);
double
get_sea_level(double**, gint, double);
...
gboolean
dump_sea_level_data(gpointer ptr, FILE* fp)
{
...
gboolean
load_sea_level_data(gpointer ptr, FILE* fp)
{
    Sea_level_t* data = (Sea_level_t*)ptr;
    guint len;
...
double
get_sea_level(double** sea_level, gint len, double year)
{
    double new_sea_level;
