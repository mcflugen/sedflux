...
void
esmf_sedflux_init(void);
void
esmf_sedflux_run(void);
void
esmf_sedflux_finalize(void);
...
void
esmf_sedflux_setup(void)
{
    param = sedflux_setup(command_s);
}
void
esmf_sedflux_init(void)
{
    sedflux_init(q,  p, init_file);
}
void
esmf_sedflux_run(void)
{
    sedflux_run_time_step(*q, *p);
}
void
esmf_sedflux_finalize(void)
{
