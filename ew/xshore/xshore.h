...
Sed_cube*
get_shelf_zones(Sed_cube p,
    double z_0,
    gint** shelf_ind);
Sed_cube*
get_bruun_zones(Sed_cube p,
    double y_0);
Sed_cube*
get_zones(Sed_cube p,
    double* z,
    gint n_zones,
    Sed_grid_func f,
    gint** ind);
...
double
get_advection_constant(double z,
    Sed_wave w,
    double u_0,
    double settling_velocity,
    double breaker_depth);
...
double
get_bruun_depth(double y, double y_0,
...
double
get_near_bed_velocity(double water_depth,
    Sed_wave w,
    double breaker_depth);
double
near_bed_velocity_func(double water_depth,
    Sed_wave w,
    double breaker_depth);
double
near_bed_velocity_func_mean(double water_depth,
    Sed_wave w,
    double breaker_depth);
double
...
near_bed_velocity_func_stokes(double water_depth,
    ...
    double breaker_depth);
double
get_grain_size_threshold(double orbital_velocity,
    double wave_period);
G_END_DECLS
