...
*/
void sub_run (Subside_state* s, double t);

/** Destroy a Subside_state

@param s A Subside_state
*/
void sub_destroy (Subside_state* s);
...
*/
const double* sub_get_deflection (Subside_state* s);
const double* sub_get_load (Subside_state*);
const double* sub_get_x (Subside_state*);
const double* sub_get_y (Subside_state*);

int sub_get_nx (Subside_state*);
