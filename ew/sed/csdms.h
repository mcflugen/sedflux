...
*/
typedef gboolean(CSDMSGetValFunc)(CSDMSComp* c, const gchar* val_s, gint* where,
    double when, double** vals);
...
CSDMSComp*
csdms_comp_set_irf(CSDMSComp* c, CSDMSInitFunc, CSDMSGetValFunc, CSDMSFinalizeFunc);
