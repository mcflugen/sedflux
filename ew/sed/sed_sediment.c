...
Sed_sediment
sed_sediment_copy(Sed_sediment dest, const Sed_sediment src)
{
    eh_require(src);
...
Sed_sediment
sed_sediment_dup(const Sed_sediment src)
{
    return sed_sediment_copy(NULL, src);
}

gssize
sed_sediment_n_types(const Sed_sediment sed)
{
    if (sed) {
        return sed->len;
    } else {
...
Sed_sediment
sed_sediment_resize(Sed_sediment s, gssize new_len)
{
    if (new_len > 0) {
...
Sed_sediment
sed_sediment_add_type(Sed_sediment sed, const Sed_type new_type)
{
    eh_require(sed);
    eh_require(new_type);
...
Sed_sediment
sed_sediment_insert_sorted(Sed_sediment s, Sed_type t)
{
    eh_require(s);
    eh_require(t);
...
Sed_sediment
sed_sediment_append(Sed_sediment s, Sed_type t)
{
    eh_require(s);
    eh_require(t);
...
sed_sediment_property_avg_with_data(Sed_sediment s, double* f,
    Sed_type_property_func_with_data p_func, gpointer data)
{
    double val = 0;
...
Sed_type
sed_sediment_type(const Sed_sediment s, gssize id)
{
    Sed_type t = NULL;
...
Sed_type
sed_sediment_bedload(const Sed_sediment s)
{
    return s->l[0];
}

Sed_sediment
sed_sediment_destroy(Sed_sediment s)
{
    if (s) {
        gssize i;
...
double
sed_sediment_bedload_rho(const Sed_sediment s)
{
    return sed_type_rho_sat(s->l[0]);
}

gssize
sed_sediment_write(FILE* fp, const Sed_sediment s)
{
    gssize n = 0;
...
Sed_type
sed_type_set_plastic_index(Sed_type t, double pi)
{
    t->pi = pi;
    return t;
}
...
double
sed_type_shear_strength_with_data(const Sed_type t, gpointer data)
{
...
double
sed_type_cohesion_with_data(const Sed_type t, gpointer data)
{
...
double
sed_type_consolidation_with_data(const Sed_type t, gpointer data)
{
...
double
sed_type_consolidation_rate_with_data(const Sed_type t, gpointer data)
{
    return sed_type_consolidation_rate(t, ((double*)data)[0], ((double*)data)[1]);
}
...
double
sed_type_is_size_class_with_data(Sed_type t, gpointer size)
{
    return sed_type_is_size_class(t, *((Sed_size_class*)size));
}

double
sed_type_sum_size_classes_with_data(Sed_type t, gpointer size)
{
...
double
sed_type_void_ratio_compacted(Sed_type t, gpointer d)
{
    return (*(double*)d) * (1 + sed_type_void_ratio(t)) - 1;
}

double
sed_type_density_compacted(Sed_type t, gpointer d)
{
