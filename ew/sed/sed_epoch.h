...
Sed_epoch
sed_epoch_set_name(Sed_epoch e, gchar* name);
Sed_epoch
sed_epoch_set_number(Sed_epoch e, gssize name);
Sed_epoch
...
Sed_epoch
sed_epoch_sscan_prefix(Sed_epoch e, const gchar* prefix,
    GError** error);
Sed_epoch
...
Sed_epoch_queue
sed_epoch_queue_new(const gchar* file, const gchar* prefix,
    GError** error);
Sed_epoch_queue
...
Sed_epoch_queue
sed_epoch_queue_destroy(Sed_epoch_queue q);
...
sed_epoch_queue_test_run(const Sed_epoch_queue q,
    ...
    GError**              error);
Sed_epoch_queue
sed_epoch_queue_run(Sed_epoch_queue       q,
    Sed_cube              p);

Sed_epoch_queue
sed_epoch_queue_tic(Sed_epoch_queue epoch_q, Sed_cube p);
Sed_epoch_queue
sed_epoch_queue_run_until(Sed_epoch_queue epoch_q, Sed_cube p, double t_in_years);
