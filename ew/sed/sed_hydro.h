...
Sed_hydrotrend_header*
sed_hydro_scan_inline_header(FILE* fp);
gssize
sed_hydro_read_n_records(FILE* fp, Sed_hydro* rec, int n_grains, int n_recs);
...
Sed_hydro
sed_hydro_set_time(Sed_hydro a, double t_0);
Sed_hydro*
...
Sed_hydro
sed_hydro_add_cell(Sed_hydro a, const Sed_cell s);
Sed_hydro
sed_hydro_subtract_cell(Sed_hydro a, const Sed_cell s);
Sed_hydro
...
Sed_hydro*
sed_hydro_array_eventize_fraction(Sed_hydro* rec_a, double f);
Sed_hydro*
sed_hydro_array_eventize_conc(Sed_hydro* rec_a, double c);
Sed_hydro*
sed_hydro_array_eventize(Sed_hydro* rec_a, double f, gboolean insert);
Sed_hydro*
sed_hydro_process_records(Sed_hydro* rec_a,
    gssize     n_recs,
    gssize     n_sig_values,
