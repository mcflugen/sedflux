...
main (int argc, char* argv[])
{
  ...
  g_test_add_func ("/libsed/sed_column/top_prop_with_load", &test_sed_column_top_property_with_load );
  ...
  g_test_add_func ("/libsed/sed_column/limits/destroy_null", &test_sed_column_destroy_null );
  ...
  g_test_add_func ("/libsed/sed_column/limits/add_empty_cell", &test_sed_column_add_cell_empty );
  g_test_add_func ("/libsed/sed_column/limits/resize_neg", &test_sed_column_resize_cell_neg );
  g_test_add_func ("/libsed/sed_column/limits/resize_over", &test_sed_column_resize_cell_over );
  g_test_add_func ("/libsed/sed_column/limits/resize_under", &test_sed_column_resize_cell_under );
  g_test_add_func ("/libsed/sed_column/limits/load_partial", &test_sed_column_load_partial );
  ...
  g_test_add_func ("/libsed/sed_column/limits/index_at_above", &test_sed_column_index_at_above );
  g_test_add_func ("/libsed/sed_column/limits/index_at_below", &test_sed_column_index_at_below );
  g_test_add_func ("/libsed/sed_column/limits/height_empty", &test_sed_column_height_empty );
  g_test_add_func ("/libsed/sed_column/limits/height_null", &test_sed_column_height_null );
  g_test_add_func ("/libsed/sed_column/limits/thickenss_neg", &test_sed_column_thickness_index_neg );
  g_test_add_func ("/libsed/sed_column/limits/thickness_above", &test_sed_column_thickness_index_above );
  g_test_add_func ("/libsed/sed_column/limits/thickness_null", &test_sed_column_thickness_index_null );
  g_test_add_func ("/libsed/sed_column/limits/thickness_empty", &test_sed_column_thickness_index_empty );
  ...
  g_test_add_func ("/libsed/sed_column/limits/extract_above_0", &test_sed_column_extract_above_0 );
  g_test_add_func ("/libsed/sed_column/limits/extract_above_1", &test_sed_column_extract_above_1 );
  g_test_add_func ("/libsed/sed_column/limits/extract_above_2", &test_sed_column_extract_above_2 );
  ...
  g_test_add_func ("/libsed/sed_column/limits/add_cell_null", &test_sed_cell_add_column_null );
  g_test_add_func ("/libsed/sed_column/limits/add_cell_dup", &test_sed_cell_add_column_dup );
  ...
  g_test_add_func ("/libsed/sed_column/limits/remove_above", &test_sed_column_remove_above );
  g_test_add_func ("/libsed/sed_column/limits/remove_below", &test_sed_column_remove_below );
  g_test_add_func ("/libsed/sed_column/limits/remove_empty", &test_sed_column_remove_empty );
