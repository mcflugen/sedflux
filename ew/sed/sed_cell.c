...
sed_cell_size_class_percent(const Sed_cell c, Sed_size_class size)
{
    ...
    if (c) {
        p = sed_sediment_property_avg_with_data(NULL, c->f, &sed_type_is_size_class_with_data,
                &size);
    }
...
sed_cell_size_classes(const Sed_cell c)
{
    ...
    if (c) {
        sed_sediment_property_avg_with_data(NULL, c->f, &sed_type_sum_size_classes_with_data,
            &size);
    }
...
{
    return sed_sediment_property_avg_with_data(NULL, c->f,
            &sed_type_shear_strength_with_data, &load);
}
...
sed_cell_cohesion(const Sed_cell c, double load)
{
    ...
    return sed_sediment_property_avg_with_data(NULL, c->f, &sed_type_cohesion_with_data,
            &load);
...
sed_cell_consolidation(const Sed_cell c, double time_now)
{
    ...
    return sed_sediment_property_avg_with_data(NULL, c->f,
            &sed_type_consolidation_with_data, data);
}
...
sed_cell_consolidation_rate(const Sed_cell c, double time_now)
{
    ...
    return sed_sediment_property_avg_with_data(NULL, c->f,
            &sed_type_consolidation_rate_with_data, data);
}
