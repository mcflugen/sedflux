...
#ifndef BMI_COMPONENT_NAME_MAX 
# define BMI_COMPONENT_NAME_MAX (2048)
#endif

#ifndef BMI_VAR_NAME_MAX 
# define BMI_VAR_NAME_MAX (2048)
#endif

#ifndef BMI_UNIT_NAME_MAX 
...
int BMI_Update_until (BMI_Model *self, double time);
int BMI_Finalize (BMI_Model * self);

int BMI_Get_component_name (BMI_Model * self, char *name);
int BMI_Get_input_var_name_count (BMI_Model * self, int * input_var_name_count);
int BMI_Get_input_var_names (BMI_Model * self, char ** names);
int BMI_Get_output_var_name_count (BMI_Model * self, int * output_var_name_count);
...
int BMI_Get_var_size (BMI_Model * self, const char * name, int *size);
...
int BMI_Get_value (BMI_Model * self, const char *name, void *dest);
