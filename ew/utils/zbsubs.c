/* zbsubs.f -- translated by f2c (version 20031025).
    ...
    *ierr)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int zzzsqrt_(doublereal*, doublereal*,
    ...
    extern doublereal zabs_(doublereal*, doublereal*);
    static doublereal csqi, atrm, ztai, csqr, ztar, trm1i, trm2i, trm1r,
           trm2r;
    ...
    extern doublereal d1mach_(integer*);
    extern integer i1mach_(integer*);
    extern /* Subroutine */ int zzzexp_(doublereal*, doublereal*,
        doublereal*, doublereal*);
    ...
    /* ***ROUTINES CALLED  ZACAI,ZBKNU,ZZZEXP,ZZZSQRT,ZABS,I1MACH,D1MACH */
    /* ***END PROLOGUE  ZAIRY */
...
L40:
    ...
    *aii = s1i * c1 - c2 * (*zr * s2i + *zi * s2r);
    ...
    zzzsqrt_(zr, zi, &str, &sti);
    ztar = tth * (*zr * str - *zi * sti);
    ztai = tth * (*zr * sti + *zi * str);
    zzzexp_(&ztar, &ztai, &str, &sti);
    ptr = *air * str - *aii * sti;
    *aii = *air * sti + *aii * str;
    *air = ptr;
    return 0;
    ...
    integer* kode, doublereal* bir, doublereal* bii, integer* ierr)
{
    ...
    /* ***ROUTINES CALLED  ZBINU,ZABS,ZDIV,ZZZSQRT,D1MACH,I1MACH */
    /* ***END PROLOGUE  ZBIRY */
...
/* Subroutine */ int zzzsqrt_(doublereal* ar, doublereal* ai, doublereal* br,
    doublereal* bi)
{
    /* Initialized data */
...
/* Subroutine */ int zzzexp_(doublereal* ar, doublereal* ai, doublereal* br,
    doublereal* bi)
{
    /* Builtin functions */
...
/* Subroutine */ int zzzlog_(doublereal* ar, doublereal* ai, doublereal* br,
...
doublereal
zabs_(doublereal* zr, doublereal* zi)
{
    /* System generated locals */
    doublereal ret_val;
    ...
    nz, doublereal* tol, doublereal* elim, doublereal* alim)
{
    ...
    extern /* Subroutine */ int zzzlog_(doublereal*, doublereal*,
        doublereal*, doublereal*, integer*), zzzexp_(doublereal*,
            doublereal*, doublereal*, doublereal*);
    ...
    *nz = 0;
    ...
    /* ----------------------------------------------------------------------- */
    fc = 1.;
    zzzlog_(&rzr, &rzi, &smur, &smui, &idum);
    fmur = smur * dnu;
    fmui = smui * dnu;
    ...
    elim)
{
    ...
    extern /* Subroutine */ int zuchk_(doublereal*, doublereal*, integer*,
        doublereal*, doublereal*), zzzlog_(doublereal*, doublereal*,
    ...
    /* ***ROUTINES CALLED  ZUCHK,ZABS,ZZZLOG */
    /* ***END PROLOGUE  ZKSCL */
    ...
    doublereal* ascle, doublereal* alim, integer* iuf)
{
    ...
    /* ***ROUTINES CALLED  ZABS,ZZZEXP,ZZZLOG */
    /* ***END PROLOGUE  ZS1S2 */
    ...
    *s1i = zeroi;
    ...
    zzzlog_(&s1dr, &s1di, &c1r, &c1i, &idum);
    c1r = c1r - *zrr - *zrr;
    c1i = c1i - *zri - *zri;
    zzzexp_(&c1r, &c1i, s1r, s1i);
    as1 = zabs_(s1r, s1i);
    ++(*iuf);
L10:
    aa = max(as1, as2);
    ...
    nz, doublereal* tol)
{
    ...
    /* ***ROUTINES CALLED  DGAMLN,D1MACH,ZABS,ZZZEXP,ZZZLOG,ZMLT */
    /* ***END PROLOGUE  ZMLRI */
    ...
    nz, doublereal* tol, doublereal* elim, doublereal* alim)
{
    ...
    /* ***ROUTINES CALLED  DGAMLN,D1MACH,ZUCHK,ZABS,ZDIV,ZZZLOG,ZMLT */
    /* ***END PROLOGUE  ZSERI */
    ...
    alim)
{
    ...
    /* ***ROUTINES CALLED  D1MACH,ZABS,ZDIV,ZZZEXP,ZMLT,ZZZSQRT */
    /* ***END PROLOGUE  ZASYI */
    ...
    alim)
{
    ...
    /* ***ROUTINES CALLED  ZUCHK,ZUNHJ,ZUNIK,D1MACH,ZABS,ZZZLOG */
    /* ***END PROLOGUE  ZUOIK */
...
L110:
    ascle = d1mach_(&c__1) * 1e3 / *tol;
    zzzlog_(&phir, &phii, &str, &sti, &idum);
    czr += str;
    czi += sti;
    ...
    zzzlog_(&argr, &argi, &str, &sti, &idum);
    czr = czr - str * .25 - aic;
    czi -= sti * .25;
L120:
    ax = exp(rcz) / *tol;
...
doublereal
dgamln_(doublereal* z__, integer* ierr)
{
    /* Initialized data */
    ...
    doublereal* sumi, doublereal* cwrkr, doublereal* cwrki)
{
    ...
    /* ***ROUTINES CALLED  ZDIV,ZZZLOG,ZZZSQRT,D1MACH */
    /* ***END PROLOGUE  ZUNIK */
...
L15:
    ...
    zzzsqrt_(&sr, &si, &srr, &sri);
    str = coner + srr;
    sti = conei + sri;
    zdiv_(&str, &sti, &tr, &ti, &znr, &zni);
    zzzlog_(&znr, &zni, &str, &sti, &idum);
    *zeta1r = *fnu * str;
    *zeta1i = *fnu * sti;
    *zeta2r = *fnu * srr;
    *zeta2i = *fnu * sri;
    ...
    srr = tr * rfn;
    sri = ti * rfn;
    zzzsqrt_(&srr, &sri, &cwrkr[16], &cwrki[16]);
    ...
    doublereal* asumi, doublereal* bsumr, doublereal* bsumi)
{
    ...
    extern doublereal d1mach_(integer*);
    static doublereal rzthr, rtzti, rtztr, przthi, przthr;
    extern /* Subroutine */ int zzzlog_(doublereal*, doublereal*,
        doublereal*, doublereal*, integer*);
    ...
    /* ***ROUTINES CALLED  ZABS,ZDIV,ZZZLOG,ZZZSQRT,D1MACH */
    /* ***END PROLOGUE  ZUNHJ */
...
L20:
    ...
    *argr = zetar * fn23;
    *argi = zetai * fn23;
    zzzsqrt_(&sumar, &sumai, &zar, &zai);
    zzzsqrt_(&w2r, &w2i, &str, &sti);
    *zeta2r = str * *fnu;
    *zeta2i = sti * *fnu;
    ...
    *l2, ftnlen mess_len)
{
    ...
    /* These are unused
        ...
        static cilist io___1274 = { 0, 6, 0, 0, 0 };
        static cilist io___1275 = { 0, 6, 0, fmt_900, 0 };
    */
