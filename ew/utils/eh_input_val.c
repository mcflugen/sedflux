...
{
    Eh_input_val_type
    type;    //< The type of Eh_input_val.  This defines the way the value changes.
    FILE*
    fp;      //< Pointer to a user-specified file, if necessary.  NULL, otherwise.
    gchar*
    file;    //< The name of a user-specified file, if necessary.  NULL, otherwise.
    ...
    GRand*
    rand;    //< A random number generator, if necessary.  NULL, otherwise.
