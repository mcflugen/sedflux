...
void
eh_psdes(unsigned long* lword, unsigned long* irword)
{
...
double
eh_reject(double (*p)(double), double (*f)(double), double (*F)(double))
{
...
double
eh_maxpowdev(double a, double n, long* idum)
{
    double eh_ran2(long * idum);
    double dum;
...
*/
double
eh_rand_exponential(GRand* rand, double mu)
{
    double dum;
...
*/
double
eh_rand_max_exponential(GRand* rand, double mu, double n)
{
    double dum;
...
*/
double
eh_log_normal(GRand* rand, double mu, double sigma)
{
...
*/
double
eh_max_log_normal(GRand* rand, double mu, double sigma, double n)
{
    double eh_ran2(long * idum);
    double dum;
...
*/
double
eh_rand_weibull(GRand* rand, double eta, double beta)
{
    double dum;
...
*/
double
eh_rand_max_weibull(GRand* rand, double eta, double beta, double n)
{
    double dum;
    double z;
    double ans;
...
*/
double
eh_rand_user(GRand* rand, double* x, double* F, gssize len)
{
...
*/
double
eh_rand_normal(GRand* rand, double mu, double sigma)
{
...
double
eh_get_fuzzy_dbl(double min, double max)
{
    return g_random_double_range(min, max);
}

double
eh_get_fuzzy_dbl_norm(double mean, double std)
{
    return eh_rand_normal(NULL, mean, std);
}

double
eh_get_fuzzy_dbl_log_norm(double mean, double std)
{
    return eh_log_normal(NULL, mean, std);
}

gint32
eh_get_fuzzy_int(gint32 min, gint32 max)
{
