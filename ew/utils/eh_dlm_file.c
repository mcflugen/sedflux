...
gchar*
eh_dlm_prepare(const gchar* file,
    GError** err);
double**
...
gint
eh_dlm_find_n_cols(gchar* content, const gchar* delims);
gint
eh_dlm_find_n_rows(gchar* content, gint delim);
...
*/
double**
eh_dlm_read_swap(const gchar* file,
    const gchar* delims,
    gint* n_rows,
    gint* n_cols,
    GError** err)
...
gint
eh_dlm_print(const gchar* file, const gchar* delim, const double** data,
    const gint n_rows, const gint n_cols, GError** error)
{
    return eh_dlm_print_full(file, delim, data, n_rows, n_cols, FALSE, error);
}

gint
eh_dlm_print_swap(const gchar* file, const gchar* delim, const double** data,
    const gint n_rows, const gint n_cols, GError** error)
{
...
gint
eh_dlm_print_full(const gchar* file, const gchar* delim, const double** data,
    const gint n_rows, const gint n_cols, gboolean swap, GError** error)
{
    gint n = 0;
...
gint
eh_dlm_print_dbl_grid(const gchar* file, const gchar* delim, Eh_dbl_grid g,
    GError** error)
{
    gint n = 0;
