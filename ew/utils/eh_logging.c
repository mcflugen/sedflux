...
FILE*
eh_open_log_file(const char* log_name)
{
    FILE* fp;
    char* good_name;
...
void
eh_print_log(const char* log_name, const char* message, ...)
{
...
void
eh_close_log(const char* log_name)
{
    GPtrArray* log_fp_vec;
...
void
eh_redirect_log(const char* log_file1, const char* log_file2)
{
...
void
eh_reset_log(const char* log_file)
{
    GPtrArray* log_fp_vec;
...
void
eh_logger(const gchar*   log_domain,
