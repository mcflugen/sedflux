/* machcon.f -- translated by f2c (version 20031025).
...
old_i1mach_(integer* i__)
{
    ...
    static struct {
        integer e_1[16];
            ...
            5, 6, 6, 6, 32, 4, 2, 31, G_MAXLONG, 2, 24, -125, 128,
            53, -1021, 1024
        }
    };
...
r1mach_(integer* i__)
{
    ...
    static struct {
        integer e_1[5];
        integer fill_2[1];
    } equiv_4 = { {8388608, 2139095039, 864026624, 872415232, 1050288283}, {0} };
...
old_d1mach_(integer* i__)
{
    ...
    static struct {
        ...
        doublereal e_3;
            ...
            1048576, 0, 2146435071, -1, 1017118720, 0, 1018167296,
            0, 1070810131, 1352628735
        }, {0}, 0.
    };
