...
double     eh_r_squared(double* x, double* y, gssize len, Eh_dbl_func_with_data f,
    gpointer data);
...
double eh_integrate_with_data(Eh_dbl_func_with_data func, double a, double b,
    gpointer data);
...
double rtsafe(void (*funcd)(double, double*, double*, double*), double x1, double x2,
    double xacc, double*);
double eh_bisection(Eh_root_fcn f, double x_0, double x_1, double eps,
    gpointer user_data);
...
double*    eh_dbl_array_rebin_smaller(double* s, gssize n, double bin_size,
    gint* d_len);
...
double*    eh_dbl_array_running_mean(double* x, gssize len, gssize n_left,
    gssize n_right);
