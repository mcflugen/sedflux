...
int
read_usgs_daily_value_record(daily_val_st* rec, FILE* fp, int byte_order);
int
read_cdn_daily_value_record(daily_val_st* rec, FILE* fp, int byte_order);
...
main(int argc, char* argv[])
{
    ...
    eh_data_record_add_label(data, "no value", g_strdup_printf("%f",
            new_rec->novalue_mark));
    eh_data_record_add_label(data, "start month", g_strdup_printf("%d",
            new_rec->start_month));
    eh_data_record_add_label(data, "start year", g_strdup_printf("%d", new_rec->year));
    eh_data_record_add_label(data, "number of years", g_strdup_printf("%d",
