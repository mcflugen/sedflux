...
double
get_type_val(double z_0, double z_1, double z_min, int type);
double
get_rate_val(double z_0, double z_1, double z_min, int type);
double
get_time_line_val(double z_0, double z_1, double z_min, int type);
